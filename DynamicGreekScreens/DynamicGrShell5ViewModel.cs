   ...
   public class DynamicGrShell5ViewModel:Screen
    {
        ...
        public DynamicGrShell5ViewModel(IEventAggregator events, ILog log, ISendStatsService sender)
        {
            this.events = events;
            this.log = log;
            this.sender = sender;
        ...
        protected override void OnViewLoaded(object view)
        {
            ...
            ((DynamicGrShell5View)view).CloseDisclaimer.Click += CloseDisclaimer_Click;
