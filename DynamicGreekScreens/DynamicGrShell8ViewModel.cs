   ...
   public class DynamicGrShell8ViewModel:Screen
    {
        ...
        public DynamicGrShell8ViewModel(IEventAggregator events, ILog log, ISendStatsService sender)
        {
            this.events = events;
            this.log = log;
            this.sender = sender;
        ...
        protected override void OnViewLoaded(object view)
        {
            ...
            ((DynamicGrShell8View)view).CloseDisclaimer.Click += CloseDisclaimer_Click;
