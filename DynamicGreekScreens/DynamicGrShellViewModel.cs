   ...
   public class DynamicGrShellViewModel:Screen
    {
        ...
        public DynamicGrShellViewModel(IEventAggregator events, ILog log, ISendStatsService sender)
        {
            this.events = events;
            this.log = log;
            this.sender = sender;
        ...
        protected override void OnViewLoaded(object view)
        {
            ...
            ((DynamicGrShellView)view).CloseDisclaimer.Click += CloseDisclaimer_Click;
