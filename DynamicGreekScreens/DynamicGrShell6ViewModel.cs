   ...
   public class DynamicGrShell6ViewModel:Screen
    {
        ...
        public DynamicGrShell6ViewModel(IEventAggregator events, ILog log, ISendStatsService sender)
        {
            this.events = events;
            this.log = log;
            this.sender = sender;
        ...
        protected override void OnViewLoaded(object view)
        {
            ...
            ((DynamicGrShell6View)view).CloseDisclaimer.Click += CloseDisclaimer_Click;
