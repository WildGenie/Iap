...
{
   public class DynamicBrowserEn8ViewModel:Screen
    {
        ...
        private DynamicBrowserEn8View currentView;
        ...
        public DynamicBrowserEn8ViewModel(IEventAggregator events, string numberOfAvailablePagesToPrint, ILog log, ISendStatsService sender)
        {
            this.events = events;
        ...
        public BitmapImage LeftImage8
        {
            set
            {
                ...
                NotifyOfPropertyChange(() => this.LeftImage8);
            }
        ...
        {
            currentView = ((DynamicBrowserEn8View)view);
        ...
        private void PopulatePanel(DynamicBrowserEn8View view)
        {
            ...
            switch (this.SelectedPosition)
            {
                ...
                case "8":
                    ...
                    view.Row6.Height = new GridLength(177, GridUnitType.Auto);
                    view.Row7.Height = new GridLength(177, GridUnitType.Auto);
                    view.Row8.Height = new GridLength(293, GridUnitType.Auto);
        ...
        public void ViewRedirect1()
        {
            ...
            this.InitializeBrowserAgain(this.ButtonsDetails[0].EnUrl);
        }
        ...
        public void ViewRedirect2()
        {
            ...
            this.InitializeBrowserAgain(this.ButtonsDetails[1].EnUrl);
        }
        ...
        public void ViewRedirect3()
        {
            ...
            this.InitializeBrowserAgain(this.ButtonsDetails[2].EnUrl);
        }
        ...
        public void ViewRedirect4()
        {
            ...
            this.InitializeBrowserAgain(this.ButtonsDetails[3].EnUrl);
        }
        ...
        public void ViewRedirect5()
        {
            ...
            this.InitializeBrowserAgain(this.ButtonsDetails[4].EnUrl);
        }
        ...
        public void ViewRedirect6()
        {
            ...
            this.InitializeBrowserAgain(this.ButtonsDetails[5].EnUrl);
        }
        ...
        public void ViewRedirect7()
        {
            ...
            this.InitializeBrowserAgain(this.ButtonsDetails[6].EnUrl);
        }
        ...
        public void ViewRedirect8()
        {
            ...
            NotifyOfPropertyChange(() => SelectedPosition);
            PopulatePanel(currentView);
            // _internetAccessBrowser.Load(this.ButtonsDetails[7].EnUrl);
            try
            {
                _internetAccessBrowser.Dispose();
            }
            catch { }
            this.InitializeBrowserAgain(this.ButtonsDetails[7].EnUrl);
        }
    }
}
