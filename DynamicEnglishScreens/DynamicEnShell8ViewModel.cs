   ...
   public class DynamicEnShell8ViewModel:Screen
    {
        ...
        public DynamicEnShell8ViewModel(IEventAggregator events, ILog log, ISendStatsService sender)
        {
            this.events = events;
            this.log = log;
            this.sender = sender;
        ...
        protected override void OnViewLoaded(object view)
        {
            ...
            ((DynamicEnShell8View)view).CloseDisclaimer.Click += CloseDisclaimer_Click;
